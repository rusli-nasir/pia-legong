...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oFeatures = {
				"bPaginate": true,
				"bLengthChange": false, // dedee_ak : change with true if u want to display the row numb per table option
				"bFilter": true,
				"bSort": true,
				"bInfo": true,
				"bAutoWidth": false,
			...
			this.oLanguage = {
				...
				"fnInfoCallback": null*/
				// modified by dedee_ak
				"sProcessing": "Memuat...",
				"sLengthMenu": "Menampilkan _MENU_ data",
				"sZeroRecords": "Data tidak ditemukan",
				"sEmptyTable": "Database kosong",
				"sInfo": "Data no _START_ sampai _END_ dari _TOTAL_ data",
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			if ( oSettings.sTableId !== '' )
			{
				...
				//oSettings.nTableWrapper.setAttribute( 'style', 'position:absolute;' );
			}

...
var tablePaginater = (function() {
        ...
        */
        ...
        var buildPagination = function(tblId) {
				...
				// add by dedee
				//alert($('#anyar').find('p').html());
				if($('#anyar').find('p').html() == 'hide')
				{
					document.getElementById("theTable-fdtablePaginaterWrapTop").style.display = "none";
					document.getElementById("theTable-fdtablePaginaterWrapBottom").style.display = "none";
				}				
        };

...
<div class="">
    ...
    <legend>Daftar Pemesanan</legend>
        ...
        <table id="gridview">
            <tr>
                <td class="labels_dpo">No. Pemesanan</td>
                <td class="labels_dpo">Nama Customer</td>
                <td class="labels_dbyr">Telepon / Handphone</td>
        ...
        <table id="gridview">
			...
			foreach($daftar_list_po as $daftarlistpo)
			{
				...
				?>
				<tr class="isi_list">
					<td class="labelss_dpo" id="search1"><?php echo $daftarlistpo['no_po']; ?></td>
					<td class="labelss_dpo" id="search2"><?php echo $daftarlistpo['nama_customer']; ?></td> 
					<td class="labelss_dbyr" id="search3"><?php echo $daftarlistpo['telepon']; ?>
                    ...
                    <td class="labelss_dpo"><?php if($daftarlistpo['jumlah_po'] > 0){echo 'Barang sudah diambil';}else{echo 'Barang belum diambil';}?></td>
				</tr>
                <?php
			}?>
        </table>

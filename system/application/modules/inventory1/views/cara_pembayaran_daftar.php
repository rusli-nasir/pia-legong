<script>
	...
	function addCaraBayar(cara_bayar, keterangan)
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>index.php/inventory/cara_pembayaran/add_cara_pembayaran",
	...
	function editCaraBayar(id_cara_bayar, cara_bayar, keterangan)
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>index.php/inventory/cara_pembayaran/edit_cara_pembayaran",
	...
	function hapusCaraBayar(id_cara_bayar)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>index.php/inventory/cara_pembayaran/hapus_cara_pembayaran",
	...
	function findCaraBayar(id_cara_bayar)
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>index.php/inventory/cara_pembayaran/find_cara_pembayaran",
			data: "id_cara_bayar="+id_cara_bayar,
			cache: false,

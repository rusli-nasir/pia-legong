...
class User extends Controller
{
    ...
    function index()
    {
		...
		$load_data = array(
			'form'				=> 'inventory/user/add_jabatan',
	...
	function akses_user($ambil_data)
	{
		...
		{
			$form		= 'inventory/user/add_karyawan';
			$simpan 	= 'class="disable" disabled="disabled"';
			$edit		= 'class="disable" disabled="disabled"';
			$batal		= 'class="disable" disabled="disabled"';
			$cetak		= 'class="disable" disabled="disabled"';
		...
		{
			$form		= 'inventory/user/add_permission';
			$simpan 	= '';
			$edit		= 'class="disable" disabled="disabled"';
			$batal		= 'class="disable" disabled="disabled"';
			$cetak		= 'class="disable" disabled="disabled"';
	...
	function add_jabatan()
	{
		...
		echo base_url().'index.php/inventory/user';
	}
	...
	function add_karyawan()
	{
		...
		echo base_url().'index.php/inventory/user/akses_user/karyawan_daftar';
	}
	...
	function add_user()
	{
		...
		echo base_url().'index.php/inventory/user/akses_user/form_user';
	}
	...
	function edit_user()
	{
		...
		echo base_url().'index.php/inventory/user/index_menu';
	}
	...
	function index_menu()
	{
		...
		if($get_status_user[4]['status']==2)
			$edit='';
		$mydata = array(
			'form'				=> 'inventory/user/edit_permission',
			'simpan'			=> 'class="disable" disabled="disabled"',
			'edit'				=> $edit,
			'batal'				=> 'class="disable" disabled="disabled"',
			'cetak'				=> 'class="disable" disabled="disabled"',
